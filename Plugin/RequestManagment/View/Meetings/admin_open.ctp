		...
		<div class="datagrid-toolbar">
			<div class="col-xs-12 col-sm-6 col-md-8 no-padding">
				...
				<?php  echo $this->Croogo->adminAction(
						__d('request_managment', 'Editer la date de la réunion'), '#',
						array('button' => 'primary', 'data-toggle' => 'modal', 'data-target' =>'#MeetingEditDialog')
				);?>
				<?php  echo $this->Croogo->adminAction(
						__d('request_managment', 'Membres invités'), '#',
						array('button' => 'primary', 'data-toggle' => 'modal', 'data-target' =>'#MeetingMembersEditDialog')
				);?>
				<?php  echo $this->Croogo->adminAction(
						__d('request_managment', 'Dossiers à traiter'), '#',
						array('button' => 'primary', 'data-toggle' => 'modal', 'data-target' =>'#MeetingRequestsEditDialog')
				);?>
				<?php } ?>
			</div>
