...
--
-- Structure de la table `defer_acos`
--

CREATE TABLE IF NOT EXISTS `defer_acos` (
...
--
-- Contenu de la table `defer_acos`
--

INSERT INTO `defer_acos` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`) VALUES
...
--
-- Structure de la table `defer_aros`
--

CREATE TABLE IF NOT EXISTS `defer_aros` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) DEFAULT NULL,
  `model` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `foreign_key` int(10) DEFAULT NULL,
...
--
-- Contenu de la table `defer_aros`
--

INSERT INTO `defer_aros` (`id`, `parent_id`, `model`, `foreign_key`, `alias`, `lft`, `rght`) VALUES
...
--
-- Structure de la table `defer_aros_acos`
--

CREATE TABLE IF NOT EXISTS `defer_aros_acos` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `defer_aros_acos`
--

INSERT INTO `defer_aros_acos` (`id`, `aro_id`, `aco_id`, `_create`, `_read`, `_update`, `_delete`) VALUES
(1, 3, 35, '1', '1', '1', '1'),
(2, 3, 36, '1', '1', '1', '1'),
(3, 2, 37, '1', '1', '1', '1'),
(4, 3, 44, '1', '1', '1', '1'),
...
--
-- Structure de la table `defer_blocks`
--

CREATE TABLE IF NOT EXISTS `defer_blocks` (
...
--
-- Contenu de la table `defer_blocks`
--

INSERT INTO `defer_blocks` (`id`, `region_id`, `title`, `alias`, `body`, `show_title`, `class`, `status`, `weight`, `element`, `visibility_roles`, `visibility_paths`, `visibility_php`, `params`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Structure de la table `defer_comments`
--

CREATE TABLE IF NOT EXISTS `defer_comments` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `defer_comments`
--

INSERT INTO `defer_comments` (`id`, `parent_id`, `model`, `foreign_key`, `user_id`, `name`, `email`, `website`, `ip`, `title`, `body`, `rating`, `status`, `notify`, `type`, `comment_type`, `lft`, `rght`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Structure de la table `defer_contacts`
--

CREATE TABLE IF NOT EXISTS `defer_contacts` (
...
--
-- Contenu de la table `defer_contacts`
--

INSERT INTO `defer_contacts` (`id`, `title`, `alias`, `body`, `name`, `position`, `address`, `address2`, `state`, `country`, `postcode`, `phone`, `fax`, `email`, `message_status`, `message_archive`, `message_count`, `message_spam_protection`, `message_captcha`, `message_notify`, `status`, `updated`, `updated_by`, `created`, `created_by`) VALUES
(1, 'Contact', 'contact', '', '', '', '', '', '', '', '', '', '', 'you@your-site.com', 1, 0, 0, 0, 0, 1, 1, '2009-10-07 22:07:49', NULL, '2009-09-16 01:45:17', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `defer_dashboards`
--

CREATE TABLE IF NOT EXISTS `defer_dashboards` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `defer_languages`
--

CREATE TABLE IF NOT EXISTS `defer_languages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `defer_languages`
--

INSERT INTO `defer_languages` (`id`, `title`, `native`, `alias`, `status`, `weight`, `updated`, `updated_by`, `created`, `created_by`) VALUES
(1, 'Francais ', 'Francais ', 'fra', 1, 1, '2015-07-08 22:57:30', 1, '2009-11-02 20:52:00', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `defer_links`
--

CREATE TABLE IF NOT EXISTS `defer_links` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `parent_id` int(20) DEFAULT NULL,
...
--
-- Contenu de la table `defer_links`
--

INSERT INTO `defer_links` (`id`, `parent_id`, `menu_id`, `title`, `class`, `description`, `link`, `target`, `rel`, `status`, `lft`, `rght`, `visibility_roles`, `params`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Structure de la table `defer_menus`
--

CREATE TABLE IF NOT EXISTS `defer_menus` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `class` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `defer_menus`
--

INSERT INTO `defer_menus` (`id`, `title`, `alias`, `class`, `description`, `status`, `weight`, `link_count`, `params`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Structure de la table `defer_messages`
--

CREATE TABLE IF NOT EXISTS `defer_messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `defer_meta`
--

CREATE TABLE IF NOT EXISTS `defer_meta` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `defer_meta`
--

INSERT INTO `defer_meta` (`id`, `model`, `foreign_key`, `key`, `value`, `weight`, `created`, `created_by`, `updated`, `updated_by`) VALUES
(1, 'Node', 1, 'meta_keywords', 'key1, key2', NULL, '2015-07-07 02:14:01', NULL, '2015-07-07 02:14:01', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `defer_model_taxonomies`
--

CREATE TABLE IF NOT EXISTS `defer_model_taxonomies` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `model` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Node',
...
--
-- Contenu de la table `defer_model_taxonomies`
--

INSERT INTO `defer_model_taxonomies` (`id`, `model`, `foreign_key`, `taxonomy_id`) VALUES
(1, 'Node', 1, 1);

-- --------------------------------------------------------

--
-- Structure de la table `defer_nodes`
--

CREATE TABLE IF NOT EXISTS `defer_nodes` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `parent_id` int(20) DEFAULT NULL,
  `user_id` int(20) NOT NULL DEFAULT '0',
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `defer_nodes`
--

INSERT INTO `defer_nodes` (`id`, `parent_id`, `user_id`, `title`, `slug`, `body`, `excerpt`, `status`, `mime_type`, `comment_status`, `comment_count`, `promote`, `path`, `terms`, `sticky`, `lft`, `rght`, `visibility_roles`, `type`, `publish_start`, `publish_end`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Structure de la table `defer_regions`
--

CREATE TABLE IF NOT EXISTS `defer_regions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `defer_regions`
--

INSERT INTO `defer_regions` (`id`, `title`, `alias`, `description`, `block_count`, `created`, `created_by`, `updated`, `updated_by`) VALUES
...
--
-- Structure de la table `defer_roles`
--

CREATE TABLE IF NOT EXISTS `defer_roles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created` datetime DEFAULT NULL,
...
--
-- Contenu de la table `defer_roles`
--

INSERT INTO `defer_roles` (`id`, `title`, `alias`, `created`, `created_by`, `updated`, `updated_by`) VALUES
...
--
-- Structure de la table `defer_roles_users`
--

CREATE TABLE IF NOT EXISTS `defer_roles_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `defer_schema_migrations`
--

CREATE TABLE IF NOT EXISTS `defer_schema_migrations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `class` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `defer_schema_migrations`
--

INSERT INTO `defer_schema_migrations` (`id`, `class`, `type`, `created`) VALUES
...
--
-- Structure de la table `defer_settings`
--

CREATE TABLE IF NOT EXISTS `defer_settings` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `defer_settings`
--

INSERT INTO `defer_settings` (`id`, `key`, `value`, `title`, `description`, `input_type`, `editable`, `weight`, `params`, `created`, `created_by`, `updated`, `updated_by`) VALUES
...
--
-- Structure de la table `defer_taxonomies`
--

CREATE TABLE IF NOT EXISTS `defer_taxonomies` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `parent_id` int(20) DEFAULT NULL,
...
--
-- Contenu de la table `defer_taxonomies`
--

INSERT INTO `defer_taxonomies` (`id`, `parent_id`, `term_id`, `vocabulary_id`, `lft`, `rght`) VALUES
(1, NULL, 1, 1, 1, 2),
(2, NULL, 2, 1, 3, 4),
(3, NULL, 3, 2, 1, 2);
...
--
-- Structure de la table `defer_terms`
--

CREATE TABLE IF NOT EXISTS `defer_terms` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci,
...
--
-- Contenu de la table `defer_terms`
--

INSERT INTO `defer_terms` (`id`, `title`, `slug`, `description`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Structure de la table `defer_types`
--

CREATE TABLE IF NOT EXISTS `defer_types` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci,
...
--
-- Contenu de la table `defer_types`
--

INSERT INTO `defer_types` (`id`, `title`, `alias`, `description`, `format_show_author`, `format_show_date`, `format_use_wysiwyg`, `comment_status`, `comment_approve`, `comment_spam_protection`, `comment_captcha`, `params`, `plugin`, `updated`, `updated_by`, `created`, `created_by`) VALUES
...
--
-- Structure de la table `defer_types_vocabularies`
--

CREATE TABLE IF NOT EXISTS `defer_types_vocabularies` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `defer_types_vocabularies`
--

INSERT INTO `defer_types_vocabularies` (`id`, `type_id`, `vocabulary_id`, `weight`) VALUES
(24, 4, 1, NULL),
(25, 4, 2, NULL),
(30, 2, 1, NULL),
(31, 2, 2, NULL);
...
--
-- Structure de la table `defer_users`
--

CREATE TABLE IF NOT EXISTS `defer_users` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL,
...
--
-- Contenu de la table `defer_users`
--

INSERT INTO `defer_users` (`id`, `role_id`, `username`, `password`, `name`, `email`, `website`, `activation_key`, `image`, `bio`, `status`, `updated`, `updated_by`, `created`, `timezone`, `created_by`) VALUES
...
--
-- Structure de la table `defer_vocabularies`
--

CREATE TABLE IF NOT EXISTS `defer_vocabularies` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `alias` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci,
...
--
-- Contenu de la table `defer_vocabularies`
--

INSERT INTO `defer_vocabularies` (`id`, `title`, `alias`, `description`, `required`, `multiple`, `tags`, `plugin`, `weight`, `updated`, `updated_by`, `created`, `created_by`) VALUES
